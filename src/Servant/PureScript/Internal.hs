      ...
      _standardImports =
        importsFromList
          [ ImportLine "Affjax.RequestHeader" (Set.fromList ["RequestHeader(..)"]),
            ...
            ImportLine "Data.Tuple.Nested" (Set.fromList ["(/\\)"]),
            ImportLine "Data.String.NonEmpty.Internal" (Set.fromList ["NonEmptyString (..)"]),
            ImportLine "Servant.PureScript" (Set.fromList ["RequestUri (..)", "AjaxError", "class MonadAjax", "flagQueryPairs", "paramListQueryPairs", "paramQueryPairs", "request", "toHeader", "toPathSegment"]),
